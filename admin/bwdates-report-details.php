...
<head>
  ...
  <title>Josefheim Foundation || Report of Constituent Registration</title>
  <!-- base:css -->
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item ml-0">
            <h4 class="mb-0">Report of Constituent Registration</h4>
          </li>
          <li class="nav-item">
            <div class="d-flex align-items-baseline">
              <p class="mb-0">Home</p>
              <i class="typcn typcn-chevron-right"></i>
              <p class="mb-0">Report of Constituent Registration</p>
            </div>
          </li>
        </ul>
...
?>
                <h4 class="card-title" style="padding-left: 20px; padding-top: 20px;" align="center">Between Dates Report of Constituent Regsitration From <?php echo $fdate;?> To <?php echo $tdate;?></h4>
                <hr />
