...
<head>
  ...
  <title>Josefheim Foundation|| Search Constituent Details</title>
  <!-- base:css -->
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item ml-0">
            <h4 class="mb-0">Search Constituent Details</h4>
          </li>
          <li class="nav-item">
            <div class="d-flex align-items-baseline">
              <p class="mb-0">Home</p>
              <i class="typcn typcn-chevron-right"></i>
              <p class="mb-0">Search Constituent Details</p>
            </div>
          </li>
        </ul>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Search Constituent details by Registration number
                  </p>
                  <form class="forms-sample" method="post">
