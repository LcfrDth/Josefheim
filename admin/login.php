...
//COOKIES for password The third argument time()+ (10 * 365 * 24 * 60 * 60) is an expiration time for the cookie in seconds. 
//In this case, it is set to 10 years (10 * 365 * 24 * 60 * 60 seconds). This means that the cookie will be stored on the user's computer for 10 years before it expires and is automatically deleted.
...
<head>
  ...
  <title>Josefheim Foundation || Login Page</title>
  <!-- base:css -->
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <h3 style="color:goldenrod;">Josefheim Foundation</h3>
              ...
              <form class="pt-3" method="post">
               ...
               <a href="../index.php" class="auth-link text-black">Return</a>
              </form>
            </div>
          </div>
        </div>
