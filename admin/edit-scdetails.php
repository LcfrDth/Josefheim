...
$id=intval($_GET['id']);
$sql=mysqli_query($con,"update tblseniorcitizen set Name='$namesc',DateofBirth='$dob', ContactNumber='$contnum',MedicationAllergies='$commadd',EmergencyAddress='$emeradd',EmergencyContactnumber='$emercontnum' where ID='$id'");
echo "<script>alert('Constituent detail has been updated successfully');</script>";
...
<head>
  ...
  <title>Josefheim Foundation || Edit SC Details</title>
  <!-- base:css -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Update Constituent Details</h4>
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <input id="contnum" name="contnum" type="text" pattern="[0-9]+" maxlength="11" class="form-control" required="true" value="<?php echo htmlentities($row['ContactNumber']);?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Medication / Allergies</label>
                     <textarea class="form-control" id="commadd" name="commadd" rows="5"><?php echo htmlentities($row['MedicationAllergies']);?></textarea>
    ...
    <a href="change-image.php?id=<?php echo $row['ID'];?>">Change Image</a>
                    ...
                    <div class="form-group">
                     ...
                     <input id="emercontnum" name="emercontnum" pattern="[0-9]+" maxlength="11" type="text" class="form-control" required="true" value="<?php echo htmlentities($row['EmergencyContactnumber']);?>">
                    </div>
                    <?php } ?>
